...
//`Person` takes the parameters `name`
...
// Method on the `Student` class called `calculateAttendance`
// gives a percentage of how many days the student was present.
// Attendance is calculated and rounded to nearest whole number, (no decimal), using toFixed.
  calculateAttendance(){
...
class Course {
    ...
    // Method called `addStudent()` that prompts the user for
    ...
    // Method called `setTeacher()` that prompts the user for the
    ...
    // Method to mark a student's attendance called `markAttendance()`.
